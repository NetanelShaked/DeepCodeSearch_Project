...
from parser2 import DFG_python, DFG_java, DFG_ruby, DFG_go, DFG_php, DFG_javascript
...
for lang in dfg_function:
    LANGUAGE = Language('parser2/my-languages.so', lang)
    parser = Parser()
...
def GraphBertCode():
    ...
    path = "../"
    ## Required parameters
    parser.add_argument("--train_data_file", default=f"{path}dataset/{lang}/train.jsonl", type=str, required=False,
                        help="The input training data file (a json file).")
    parser.add_argument("--output_dir", default=f"saved_models/{lang}", type=str, required=False,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--eval_data_file", default=f"{path}dataset/{lang}/valid.jsonl", type=str,
                        help="An optional input evaluation data file to evaluate the MRR(a jsonl file).")
    parser.add_argument("--test_data_file", default=f"{path}dataset/{lang}/test.jsonl", type=str,
                        help="An optional input test data file to test the MRR(a josnl file).")
    parser.add_argument("--codebase_file", default=f"{path}dataset/{lang}/codebase.jsonl", type=str,
                        help="An optional input test data file to codebase (a jsonl file).")

    parser.add_argument("--lang", default=lang, type=str,
                        help="language.")
